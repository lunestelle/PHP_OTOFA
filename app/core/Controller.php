...
trait Controller
{
	...
	protected function getCSSFile($page)
	{
		...
		$sidebarNewPages = ['new_driver', 'new_taripa', 'new_tricycle', 'new_appointment', 'new_maintenance_log', 'new_franchise', 'renewal_of_franchise', 'change_of_motorcycle', 'transfer_of_ownership', 'intent_of_transfer', 'ownership_transfer_from_deceased_owner', 'appointment_details', 'new_user'];
