...
trait Controller
{
    ...
    if (in_array($page, $sidebarPages)) {
		...
		} else if (in_array($page, $calendarPage)) {
			$cssFiles[] = 'calendar_page.css';
		}
