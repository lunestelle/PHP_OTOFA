                    ...
                    <div class="col-12 d-flex justify-content-between px-4 mb-2">
                      ...
                      <div>
                        ...
                        <select class="form-control" id="color_code" name="color_code" required>
                          ...
                          <option value="Green" data-route-area="Free Zone & Zone 2" <?php echo (isset($color_code) && $color_code == 'Green' ? 'selected' : ''); ?>>Green</option>
                          <option value="Yellow" data-route-area="Free Zone & Zone 3" <?php echo (isset($color_code) && $color_code == 'Yellow' ? 'selected' : ''); ?>>Yellow</option>
                          <option value="Blue" data-route-area="Free Zone & Zone 4" <?php echo (isset($color_code) && $color_code == 'Blue' ? 'selected' : ''); ?>>Blue</option>
                        </select>
                      </div>
                      <div>
