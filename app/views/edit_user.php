                ...
                <div class="content-container mt-4">
                  ...
                  <div class="row justify-content-evenly px-5 p-3 m-1">
                    <div class="col-md-3">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Can decline appointments" id="permissionReject" name="permissions[]" <?php echo isset($userData['permissions']) && in_array('Can decline appointments', $userData['permissions']) ? 'checked' : ''; ?>>
                  ...
                  <div class="row justify-content-evenly px-5 p-3 m-1">
                    <div class="col-md-3">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="Can manage CIN (Increase or Decrease)" id="permissionsCin" name="permissions[]" <?php echo isset($userData['permissions']) && in_array('Can manage CIN (Increase or Decrease)', $userData['permissions']) ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="permissionsCin">
                          Can manage CIN (Increase or Decrease)
                        </label>
                      </div>
                      <!-- Add more cin permissions here -->
                    </div>
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-3">
