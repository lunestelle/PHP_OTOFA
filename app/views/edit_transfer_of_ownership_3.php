<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
  ...
  <form class="default-form" method="POST" action="" enctype="multipart/form-data" id="appointmentForm">
    ...
    <section id="step-3" style="display: none;">
          ...
          <div class="row px-3 p-4">
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->mc_lto_certificate_of_registration_path) && $mtopData3->mc_lto_certificate_of_registration_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="mc_lto_certificate_of_registration" data-original-image="' . $mtopData3->mc_lto_certificate_of_registration_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->mc_lto_official_receipt_path) && $mtopData3->mc_lto_official_receipt_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="mc_lto_official_receipt" data-original-image="' . $mtopData3->mc_lto_official_receipt_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->mc_plate_authorization_path) && $mtopData3->mc_plate_authorization_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="mc_plate_authorization" data-original-image="' . $mtopData3->mc_plate_authorization_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->tc_insurance_policy_path) && $mtopData3->tc_insurance_policy_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="tc_insurance_policy" data-original-image="' . $mtopData3->tc_insurance_policy_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->unit_front_view_image_path) && $mtopData3->unit_front_view_image_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="unit_front_view_image" data-original-image="' . $mtopData3->unit_front_view_image_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
                    echo '<input class="form-control" type="file" name="unit_front_view_image3" id="unit_unit_front_view_image3-input" accept="image/*" required>';
                    echo '</div>';
                  }
                ?>
                <?php
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->unit_side_view_image_path) && $mtopData3->unit_side_view_image_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="unit_side_view_image" data-original-image="' . $mtopData3->unit_side_view_image_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->sketch_location_of_garage_path) && $mtopData3->sketch_location_of_garage_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="sketch_location_of_garage" data-original-image="' . $mtopData3->sketch_location_of_garage_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->affidavit_of_income_tax_return_path) && $mtopData3->affidavit_of_income_tax_return_path) {
                    ...
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="affidavit_of_income_tax_return" data-original-image="' . $mtopData3->affidavit_of_income_tax_return_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
            ...
            <div class="col-12 d-flex mb-2">
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->proof_of_id_path) && $mtopData3->proof_of_id_path) {
                    echo '<div class="image-container position-relative">';
                    echo '<img src="' . $mtopData3->proof_of_id_path . '" class="img-fluid rounded fixed-height-image" id="proof_of_id3" alt="Proof of ID /Residence <br> (Voters/Birth/Baptismal/Marriage Cert.)">';
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="proof_of_id" data-original-image="' . $mtopData3->proof_of_id_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
              ...
              <div class="text-center col-4 px-4">
                ...
                <?php
                  if (isset($mtopData3->latest_franchise_path) && $mtopData3->latest_franchise_path) {
                    echo '<div class="image-container position-relative">';
                    echo '<img src="' . $mtopData3->latest_franchise_path . '" class="img-fluid rounded fixed-height-image" id="latest_franchise3" alt="Latest Franchise">';
                    echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="latest_franchise" data-original-image="' . $mtopData3->latest_franchise_path . '" data-mtop-id="' . $mtopData3->mtop_requirement_id . '"></button>';
                    echo '</div>';
                  } else {
                    echo '<div class="image-container">';
                    echo '<input class="form-control" type="file" name="latest_franchise3" id="latest_franchise3-input" accept="image/*" required>';
                    echo '</div>';
                  }
                ?>
                <?php
                  echo '<input type="hidden" name="original_latest_franchise3" value="' . ($mtopData3->latest_franchise_path ?? '') . '">';
                ?>
              </div>
            </div>
          </div>
      ...
      <button type="button" class="collapsible fw-bold fs-5 d-flex active-button" id="step3btnform2" onclick="toggleForm('step3form2', ['step3form1', 'step3form3'])" style="display:none;">
      ...
      <button type="button" class="collapsible fw-bold fs-5 d-flex" type="button" id="step3btnform3" onclick="toggleForm('step3form3', ['step3form1', 'step3form2'])" style="display:none;">
          ...
          <div class="row px-3 p-3">
            <div class="col-12 d-flex mb-2">
              <div class="col-4 px-5">
                ...
                <div class="input-group">
                  <input type="text" class="form-control phone-no" style="cursor: pointer;" id="operator_name3" name="operator_name3" value="<?php echo isset($tricycleData3->operator_name) ? $tricycleData3->operator_name : ''; ?>" data-toggle="tooltip" data-bs-placement="top" title="Default operator name. This field is read-only. To update, please go to Manage Profile." readonly>
              ...
              <div class="col-4 px-5">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control phone-no" style="cursor: pointer;" id="tricycle_phone_number3" name="tricycle_phone_number3" placeholder="e.g., 9123456789" value="<?php echo isset($tricycleData3->tricycle_phone_number) ? $tricycleData3->tricycle_phone_number : ''; ?>" required readonly data-toggle="tooltip" data-bs-placement="top" title="Default phone number. This field is read-only. To update, please go to Manage Profile.">
              ...
              <div class="col-4 px-5">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" style="cursor: pointer;" id="address3" name="address3" value="<?php echo isset($tricycleData3->address) ? $tricycleData3->address : ''; ?>" required readonly data-toggle="tooltip" data-bs-placement="top" title="Default address. This field is read-only. To update, please go to Manage Profile.">
                  <span class="input-group-text" data-bs-toggle="tooltip" data-bs-placement="top" title="This field is read-only.">
                    <i class="fa-solid fa-info-circle"></i>
                  </span>
                </div>
            ...
            <div class="col-12 d-flex mb-2">
              ...
              <div class="col-4 px-5">
                ...
                <select class="form-control" id="color_code3" name="color_code3" required>
                  ...
                  <option value="Red" data-route-area2="Free Zone / Zone 1" <?php echo (isset($tricycleData3->color_code) && $tricycleData3->color_code == 'Red' ? 'selected' : ''); ?>>Red</option>
                  <option value="Blue" data-route-area2="Free Zone & Zone 3" <?php echo (isset($tricycleData3->color_code) && $tricycleData3->color_code == 'Blue' ? 'selected' : ''); ?>>Blue</option>
                  <option value="Yellow" data-route-area2="Free Zone & Zone 3" <?php echo (isset($tricycleData3->color_code) && $tricycleData3->color_code == 'Yellow' ? 'selected' : ''); ?>>Yellow</option>
                  <option value="Green" data-route-area2="Free Zone & Zone 4" <?php echo (isset($tricycleData3->color_code) && $tricycleData3->color_code == 'Green' ? 'selected' : ''); ?>>Green</option>
                </select>
              </div>
              <div class="col-4 px-5">
                <label for="route_area3" class="form-label">Route Area</label>
                <div class="input-group">
                  <input type="text" class="form-control" id="route_area3" name="route_area3" style="cursor:pointer;" placeholder="Select Color Code First" data-toggle="tooltip" data-bs-placement="top" title="Please choose a Color Code to determine the Route Area for the tricycle. This field is read-only." value="<?php echo isset($tricycleData3->route_area) ? $tricycleData3->route_area : ''; ?>" readonly required>
                  <span class="input-group-text" data-bs-toggle="tooltip" data-bs-placement="top" title="This field is read-only.">
                    <i class="fa-solid fa-info-circle"></i>
                  </span>
                </div>
            ...
            <div class="col-12 d-flex mb-5">
              ...
              <div class="col-4 px-5">
                ...
                <input type="text" class="form-control text-uppercase" id="make_model_year_acquired3" name="make_model_year_acquired3" value="<?php echo isset($tricycleData3->make_model_year_acquired) ? $tricycleData3->make_model_year_acquired : ''; ?>" required>
              </div>
              <div class="col-4 px-5">
                <label for="make_model_expiry_date3" class="form-label">Model Expiry Date</label>
                <input type="date" class="form-control text-uppercase" id="make_model_expiry_date3" name="make_model_expiry_date3" value="<?php echo isset($tricycleData3->make_model_expiry_date) ? $tricycleData3->make_model_expiry_date : ''; ?>" required>
              </div>
            </div>
            ...
            <div class="col-12 d-flex mb-2">
              ...
              <?php if (!empty($tricycleData3->tricycle_cin_number_id)): ?>
                <div class="col-4 px-5">
                  ...
                  <div class="input-group">
                  <input type="text" class="form-control" id="tricycle_cin_number_id3" name="tricycle_cin_number_id3" value="<?= $tricycleData3->tricycle_cin_number_id ?>" data-toggle="tooltip" data-bs-placement="top" title="Default tricycle CIN." readonly required>
                  <span class="input-group-text" data-bs-toggle="tooltip" data-bs-placement="top" title="This field is read-only.">
                    <i class="fa-solid fa-info-circle"></i>
                  </span>
                </div>
            ...
            <div class="col-12 d-flex mb-5">
              ...
              <div class="col-4 px-5">
                ...
                <input type="date" class="form-control text-uppercase" id="coc_no_expiry_date3" name="coc_no_expiry_date3" value="<?php echo isset($tricycleData3->coc_no_expiry_date) ? $tricycleData3->coc_no_expiry_date : ''; ?>" required>
              </div>
            </div>
            ...
            <div class="col-12 d-flex mb-2">
              <?php if (!empty($tricycleData3->tricycle_cin_number_id)): ?>
                <div class="col-4 px-5">
                  ...
                  <input type="text" class="form-control" id="lto_cr_no3" name="lto_cr_no3" value="<?php echo isset($tricycleData3->lto_cr_no) ? $tricycleData3->lto_cr_no : ''; ?>" required>
                </div>
                <div class="col-4 px-5">
                  <label for="lto_or_no3" class="form-label">LTO OR Number</label>
                  <input type="text" class="form-control text-uppercase" id="lto_or_no3" name="lto_or_no3" value="<?php echo isset($tricycleData3->lto_or_no) ? $tricycleData3->lto_or_no : ''; ?>" required>
                </div>

                <?php if (!empty($driverDataArray)): ?>
                  <?php $driver = $driverDataArray[2]; ?>
                  <div class="col-4 px-5">
