<div class="content-container mt-2 mb-3">
  ...
  <div class="row px-3 p-4">
    ...
    <div class="col-12 d-flex mb-2">
      ...
      <div class="text-center col-4 px-4">
        ...
        <input type="file" class="form-control" id="drivers_cert_safety_driving_seminar" name="drivers_cert_safety_driving_seminar" accept="image/*" required/>
      </div>
    </div>
  ...
  <div class="row px-3 p-4" id="deceasedOwnerSection" >
    ...
    <div class="col-12 d-flex mb-3">
      <div class="text-center col-4 px-4">
        ...
        <input type="file" class="form-control" id="death_certificate" name="death_certificate" accept="image/*" />
      </div>
      <div class="text-center col-4 px-4">
        <label for="agreement_amongst_heirs" class="form-label">Agreement amongst Heirs</label>
        <input type="file" class="form-control" id="agreement_amongst_heirs" name="agreement_amongst_heirs" accept="image/*" />
      </div>
    </div>
  </div>
  <div class="row px-3 p-4" id="intentOfTransferSection">
    ...
    <div class="col-12 d-flex mb-3" >
      <div class="text-center col-4 px-4">
        ...
        <input type="file" class="form-control" id="deed_of_donation_or_deed_of_sale" name="deed_of_donation_or_deed_of_sale" accept="image/*" />
      </div>
    </div>
  </div>
</div>