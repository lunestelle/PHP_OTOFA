<div id="print-content" class="print-content row mt-1">
  <div class="col-lg-12 mx-auto">
    <div class="row">
      <div class="col-12">
        <div class="container-1">
          <div class="text-center header-print" style="font-size: 16px; margin-bottom: 30px;">
          ...
          <div class="application-form col-12 mt-5">
            <div class="d-flex">
              <div class="col-8">
            ...
            <div class="d-flex">
              <div class="col-5">
                <p><span class="label text-start">Driver's License:</span> <span class="form-input-line"><?php echo isset($tricycleApplication->driver_license_no) ? ($tricycleApplication->driver_license_no) : ''; ?></span></p>
              </div>
              <div class="col-5">
                <?php
       ...
       <div class="container-1">
        <div class="d-flex inspection-report">
            ...
            <div class="col-12">
              ...
              <div class="">REMARKS:  _____________________________________________________________________________________________</div> 
            </div>
            <div class="col-12">
              <div class="row mx-5 mt-4">
                <p class="fw-bold mt-3"  style="font-size: 14px;">CERTIFICATE OF ROADWORTHINESS</p>
