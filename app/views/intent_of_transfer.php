<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
  ...
  <div class="row">
    <div class="col-12 text-uppercase nav-top" id="mainAppointmentForm">
      <h6 class="title-head">Schedule an<span class="mx-1" style="color:#ff8356;">Intent of Transfer</span> Appointment</h6>
    </div>
              ...
              <div class="row px-3 p-4" id="intentOfTransferSection">
                ...
                <div class="col-12 d-flex mb-3" >
                  <div class="col-4 px-4">
                    ...
                    <input type="file" class="form-control" id="deed_of_donation_or_deed_of_sale" name="deed_of_donation_or_deed_of_sale" accept="image/*" required/>
                  </div>
                </div>
              </div>
            </div>
