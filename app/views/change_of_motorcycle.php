<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
  ...
  <div class="row">
    <div class="col-12 text-uppercase nav-top" id="mainAppointmentForm">
      <h6 class="title-head">Schedule <span class="mx-2" style="color:#ff8356;">Change of Motorcycle </span> Appointment</h6>
    </div>
    <div class="col-lg-12 mt-2">
      <?php if ($userRole === 'operator'): ?>  
        <div class="row assessmentFeeContainer">
          <div class="col-12 mx-auto text-center mt-4">
            <p id="assessmentFeeText" class="text-muted fw-bold fst-italic" style="padding: 10px; color:gray; border: 1px solid #ff8356; background-color: #fff9ea; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.2);"></p>
          </div>
        </div>
      <?php endif; ?>
      ...
      <section id="step-3" style="display: none;">
        <div class="content-container mt-2 mb-3">
          ...
          <div class="row px-3 p-2">
            <div class="text-center text-uppercase fw-bolder">
              <h6>Old Unit</h6>
            </div>
          ...
          <div class="row px-3 p-2">
            <div class="text-center text-uppercase fw-bolder mb-2">
              <h6>New Unit</h6>
            </div>
            <div class="col-12 d-flex mb-2">
              <div class="col-4 px-4">
