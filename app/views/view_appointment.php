        ...
        <div class="col-12 pt-2">
          <div class="container pt-4">
            ...
            <section id="step-2" style="display: none;">
              <?php if (count($tricycleApplications) >= 1): ?>
                <?php foreach ($tricycleApplications as $tricycleApplication): ?>
                  <div class="content-container mt-4">
                    <div class="container mt-3">
                      <div class="d-flex justify-content-center">
                        <div class="row px-3">
                          ...
                          <div class="col-md-3 mt-3">
                            <p><?php echo ucwords(strtolower($tricycleApplication->operator_name)); ?></p>
                            <p><?php echo ($tricycleApplication->tricycle_phone_number); ?></p>
                            <p><?php echo ucwords(strtolower($tricycleApplication->color_code)); ?></p>
                            <p><?php echo ucwords(strtolower($tricycleApplication->make_model)); ?></p>
                            <p><?php echo($tricycleApplication->make_model_year_acquired); ?></p>
                            <p><?php echo ucwords(strtolower($tricycleApplication->coc_no)); ?></p>
                            <p><?php echo $tricycleApplication->tricyclePlateNumber; ?></p>
                            <?php if (!empty($tricycleApplication->lto_or_no)): ?>
                              <p><?php echo $tricycleApplication->lto_or_no; ?></p>
                            <?php endif; ?>
                            <?php if (!empty($tricycleApplication->driver_license_no)): ?>
                              <p><?php echo  $tricycleApplication->driver_license_no; ?></p>
                            <?php endif; ?>
                            <?php if (!empty($tricycleApplication->driver_license_expiry_date) && $tricycleApplication->driver_license_expiry_date != "0000-00-00"): ?>
                              <p><?php echo ($tricycleApplication->driver_license_expiry_date); ?></p>
                            <?php endif; ?>
                          </div>
                          <div class="col-md-6">
                            <div class="row mt-3">
                              <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                <?php if ($appointment->appointment_type === "New Franchise" && $appointment->status == "Pending" && !empty($tricycleApplication->driver_name)) : ?>
                                <?php else : ?>
                                  <?php if (!empty($tricycleApplication->driver_name)) : ?>
                              ...
                              <div class="col-md-6">
                                ...
                                <p><?php echo strtoupper($tricycleApplication->mtop_no); ?></p>
                                <p><?php echo ($tricycleApplication->route_area); ?></p>
                                <p><?php echo ($tricycleApplication->make_model_expiry_date); ?></p>
                                <p><?php echo ucwords(strtolower($tricycleApplication->motor_number)); ?></p>
                                <p><?php echo ($tricycleApplication->coc_no_expiry_date); ?></p>
                                <p><?php echo ($tricycleApplication->insurer); ?></p>
                                <?php if (!empty($tricycleApplication->lto_cr_no)): ?>
                                  <p><?php echo ($tricycleApplication->lto_cr_no); ?></p>
                                <?php endif; ?>
                                <?php if ($appointment->appointment_type === "New Franchise" && $appointment->status == "Pending" && !empty($tricycleApplication->driver_name)) : ?>
                                <?php else : ?>
                                  <?php if (!empty($tricycleApplication->driver_name)) : ?>
                                    <p><?php echo ($tricycleApplication->driver_name); ?></p>
                                  <?php endif; ?>
                                <?php endif; ?>
                              </div>
                            </div>
              ...
              <section id="step-3" style="display: none;">
                <?php if (count($mtopRequirements) >= 1): ?>
                  <?php foreach ($mtopRequirements as $mtopRequirement): ?>
