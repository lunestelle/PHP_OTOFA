            ...
            <div id="editAppointmentForm">
              <form class="default-form" method="POST" action="" id="appointmentForm" enctype="multipart/form-data">
                  ...
                  <div class="row px-3 p-4">
                    ...
                    <div class="col-12 d-flex mb-2">
                      <div class="text-center col-4 px-4">
                        ...
                        <?php
                          if (isset($death_certificate_path) && $death_certificate_path) {
                            echo '<div class="image-container position-relative">';
                            echo '<img src="' . $death_certificate_path . '" class="img-fluid rounded fixed-height-image" id="death_certificate" alt="Death Certificate">';
                            echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="death_certificate" data-original-image="' . $death_certificate_path . '"></button>';
                            echo '</div>';
                          } else {
                            echo '<div class="image-container">';
                            echo '<input class="form-control" type="file" name="death_certificate" id="death_certificate-input" accept="image/*" required>';
                            echo '</div>';
                          }
                        ?>
                        <?php
                          echo '<input type="hidden" name="original_death_certificate" value="' . ($death_certificate_path ?? '') . '">';
                        ?>
                      </div>
                      <div class="text-center col-4 px-4">
                        <label for="agreement_amongst_heirs" class="form-label">Agreement amongst Heirs</label>
                        <?php
                          if (isset($agreement_amongst_heirs_path) && $agreement_amongst_heirs_path) {
                            echo '<div class="image-container position-relative">';
                            echo '<img src="' . $agreement_amongst_heirs_path . '" class="img-fluid rounded fixed-height-image" id="agreement_amongst_heirs" alt="Death Certificate">';
                            echo '<button type="button" class="btn-close position-absolute top-0 end-0 m-2 remove-image-btn" data-bs-toggle="modal" data-bs-target="#deleteImageModal" data-image-type="agreement_amongst_heirs" data-original-image="' . $agreement_amongst_heirs_path . '"></button>';
                            echo '</div>';
                          } else {
                            echo '<div class="image-container">';
                            echo '<input class="form-control" type="file" name="agreement_amongst_heirs" id="agreement_amongst_heirs-input" accept="image/*" required>';
                            echo '</div>';
                          }
                        ?>
                        <?php
                          echo '<input type="hidden" name="original_agreement_amongst_heirs" value="' . ($agreement_amongst_heirs_path ?? '') . '">';
                        ?>
                      </div>
                    </div>
                  </div>
                ...
                <div class="text-end my-3">
                  <button type="submit" class="sidebar-btnContent" name="update_ownership_transfer_from_deceased_owner" id="update_ownership_transfer_from_deceased_owner">Update</button>
