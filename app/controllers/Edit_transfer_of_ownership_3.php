...
class Edit_transfer_of_ownership_3
{
  use Controller;
  ...
  public function index()
  {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      if (isset($_POST['update_transfer_of_ownership'])) {
        $formErrors = $this->validateAppointmentAndTricycleFormData($appointmentFormData, $tricycleApplicationFormData1, $tricycleApplicationFormData2, $tricycleApplicationFormData3, $appointmentModel, $tricycleApplicationModel);

        if (!empty($formErrors)) {
          $firstError = reset($formErrors);
          set_flash_message($firstError[0], "error");
          // $data = array_merge($data, $_POST);
          echo $this->renderView('edit_transfer_of_ownership_3', true, $data);
          return;
        } else {
          ...
          if ($appointmentModel->update(['appointment_id' => $appointmentId], $appointmentFormData) && $tricycleApplicationModel->update(['tricycle_application_id' => $tricycleApplicationDataArray[0]->tricycle_application_id], $tricycleApplicationFormData1) && $tricycleApplicationModel->update(['tricycle_application_id' => $tricycleApplicationDataArray[1]->tricycle_application_id], $tricycleApplicationFormData2) && $tricycleApplicationModel->update(['tricycle_application_id' => $tricycleApplicationDataArray[2]->tricycle_application_id], $tricycleApplicationFormData3)) {
            ...
            if (!empty($fileUploads1) && !empty($fileUploads2) && !empty($fileUploads3)) {
              ...
              $mtopRequirementModel->update(['mtop_requirement_id' => $mtopRequirementDataArray[1]->mtop_requirement_id], $fileUploads3);
            }
            ...
            if ($appointmentFormData['status'] === 'Completed') {
              ...
              $tricycleData3 = $tricycleModel->first(['cin_id' => $tricycleApplicationDataArray[2]->tricycle_cin_number_id]);
              ...
              if (!empty($tricycleData3)) {
                $previousTricycleApplicationId3 = $tricycleData3->tricycle_application_id;
          
                $tricycleUpdateData3 = [
                  'tricycle_application_id' => $tricycleApplicationDataArray[2]->tricycle_application_id,
                  'previous_tricycle_application_id' => $previousTricycleApplicationId3,
                  'mtop_requirements_transfer_ownership_id' =>  $mtopRequirementDataArray[2]->mtop_requirement_id,
                  'user_id' => $appointmentData->user_id,
                ];
        
                $tricycleModel->update(['tricycle_id' => $tricycleData3->tricycle_id], $tricycleUpdateData3);
              }
            }
  ...
  private function validateAppointmentAndTricycleFormData($appointmentFormData, $tricycleApplicationFormData1, $tricycleApplicationFormData2, $tricycleApplicationFormData3, $appointmentModel, $tricycleApplicationModel) {
    $errors = array();
    ...
    } elseif (empty($tricycleApplicationFormData3['driver_id'])) {
      $errors['tricycleApplication3'][] = 'Driver Name is required';
    }
