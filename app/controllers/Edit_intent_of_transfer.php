...
class Edit_intent_of_transfer
{
  ...
  public function index()
  {
    ...
    $data = [
      ...
      'deed_of_donation_or_deed_of_sale_path' => $mtopRequirementData->deed_of_donation_or_deed_of_sale_path,
      ...
      if (isset($_POST['confirm_delete_image'])) {
        ...
        if (file_exists($_POST['original_image_path'])) {
          ...
          if ($deleted) {
            ...
            redirect('edit_intent_of_transfer?appointment_id=' . $appointmentId);
          } else {
            ...
            if ($appointmentFormData['status'] === 'Completed') {
              ...
              if (!empty($tricycleData)) {
                ...
                $tricycleUpdateData = [
                  ...
                  'mtop_requirements_intent_of_transfer_id' => $mtopRequirementId,
  ...
  {
    return "1. LTO Certificate of Registration (MC of New Unit) (2 copies)<br>2. LTO Official Receipt (MC of New Unit) (2 copies)<br>3. Plate authorization (MC of New Unit) (2 copies)<br>4. Insurance Policy (TC) (New Owner) (2 copies)<br>5. Voters ID or Birth Certificate or Baptismal Certificate or Marriage Certificate or Brgy proof of residence (2 copies)<br>6. Sketch Location of Garage (2 copies)<br>7. Affidavit of No Income Or Latest Income Tax Return (2 copies)<br>8. Picture of New Unit (Front view & Side view) (2 copies)<br>9. Driver's Certificate of Safety Driving Seminar (2 copies)<br>10. Latest Franchise (2 copies)<br><br>Additional Requirement<br>1. Deed of Donation or Deed of sale";
  } 
}