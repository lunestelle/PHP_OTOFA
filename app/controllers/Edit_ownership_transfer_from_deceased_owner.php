...
class Edit_ownership_transfer_from_deceased_owner
{
  use Controller;
  ...
  public function index()
  {
    ...
    $data = [
      ...
      'death_certificate_path' => $mtopRequirementData->death_certificate_path,
      'agreement_amongst_heirs_path' => $mtopRequirementData->agreement_amongst_heirs_path,
      ...
      if (isset($_POST['confirm_delete_image'])) {
        ...
        if (file_exists($_POST['original_image_path'])) {
          ...
          if ($deleted) {
            ...
            redirect('edit_ownership_transfer_from_deceased_owner?appointment_id=' . $appointmentId);
          } else {
          ...
          if ($appointmentModel->update(['appointment_id' => $appointmentId], $appointmentFormData) && $tricycleApplicationModel->update(['appointment_id' => $appointmentId], $tricycleApplicationFormData)) {
            ...
            if ($appointmentFormData['status'] === 'Completed') {
              ...
              $tricycleUpdateData = [
                ...
                'mtop_requirements_transfer_from_deceased_id' => $mtopRequirementId,
                'status' => "Active",
  ...
  {
    return "1. LTO Certificate of Registration (MC of New Unit) (2 copies)<br>2. LTO Official Receipt (MC of New Unit) (2 copies)<br>3. Plate authorization (MC of New Unit) (2 copies)<br>4. Insurance Policy (TC) (New Owner) (2 copies)<br>5. Voters ID or Birth Certificate or Baptismal Certificate or Marriage Certificate or Brgy proof of residence (2 copies)<br>6. Sketch Location of Garage (2 copies)<br>7. Affidavit of No Income Or Latest Income Tax Return (2 copies)<br>8. Picture of New Unit (Front view & Side view) (2 copies)<br>9. Driver's Certificate of Safety Driving Seminar (2 copies)<br>10. Latest Franchise (2 copies)<br><br>Additional Requirements<br>1. Death Certificate<br>2. Agreement amongst Heirs";
  }
}