    ...
    <div class="split-section">
      <div class="split-left d-flex">
        <div>
          ...
          <form>
            <div class="field">
              <input type="email" id="email" autofocus name="email" placeholder="EMAIL" class="email_field" required>
            </div>
            <div class="field">
              <input type="password" id="password" autofocus name="password" placeholder="PASSWORD" class="password_field" required>
            </div>
            <div class="forgot_password pb-2">
